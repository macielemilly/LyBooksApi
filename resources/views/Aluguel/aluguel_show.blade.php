...
<div class="p-4 sm:ml-80">
   ...
   <h1 class="text-4xl font-bold text-gray-900">Aluguel selecionado - {{ $aluguel->nome}}</h1>
   <p>Locatário: {{ $aluguel->locatario}}</p>
   <p>Data de Aluguel: {{ $aluguel->data_aluguel_formatada }}</p>
   <p>Data de Devolução: {{ $aluguel->data_devolucao_formatada }}</p>
